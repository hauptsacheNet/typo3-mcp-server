                ...
                'properties' => [
                    ...
                    'data' => [
                        ...
                        'description' => 'Record data with field names as keys and their values (required for "create", "update", and "translate" actions). ' .
                            ...
                            ($hasMultipleLanguages ? ' Language fields (sys_language_uid) accept ISO codes like "de", "fr" instead of numeric IDs. For "translate" the data must include sys_language_uid; any additional fields (e.g. header, bodytext, title) are applied to the new translation.' : '') . ' ' .
